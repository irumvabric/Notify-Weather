...
link how to call it : https://api.openweathermap.org/data/3.0/onecall?lat={lat}&lon={lon}&exclude={part}&appid={API key}
api key : f2e5a934bf6e77754ad4c5c1521c0f96
...
## 1. [Duck Duck Go](https://openweathermap.org/api)
## 1. [Duck Duck Go](https://openweathermap.org/api)
